function searchCase(searchValue) {
    if(searchValue.includes("hackerrank"))
        window.open("https://www.hackerrank.com/domains/data-structures");
    else if(searchValue.includes("codechef"))
        window.open("https://www.codechef.com/practice?end_rating=999&group=all&hints=0&itm_campaign=practice&itm_medium=navmenu&limit=20&page=0&search=&sort_by=difficulty_rating&sort_order=asc&start_rating=0&tags=&topic=&video_editorial=0&wa_enabled=0");
        ...
        window.open("https://leetcode.com/problemset/all/?difficulty=HARD&page=1");
    else if(searchValue.includes("beginner") || searchValue.includes("easy"))
        window.open("https://leetcode.com/problemset/all/?difficulty=EASY&page=1");
    else if(searchValue.includes("intermediate") || searchValue.includes("medium"))
        window.open("https://leetcode.com/problemset/all/?difficulty=MEDIUM&page=1");
    else
